...
*Auto-generated by the training pipeline (`checkpoints/tabicl-m-sa/pipeline.sh`). Full tables: `results/sa_eval/summary_vs_baselines.md`, `results/sa_ablation/summary.md`, `results/sa_eval_20k/summary_vs_baselines.md`, `results/broad/summary.md`; training logs under `checkpoints/tabicl-m-sa/`.*
