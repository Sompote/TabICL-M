> **Historical write-up: original TabICL-M, before the Large experiments.**
> This preserves the earlier README, including its original interpretations and roadmap.
> Training status, model recommendations, and comparative claims below may be outdated.
> Use [model variants](model_variants.md) and the [current README](../README.md) for current information.
