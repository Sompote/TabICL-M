"""Insert or replace the auto-generated results section of docs/results.md between markers."""
import os, re, sys
...
TARGET = os.path.join(REPO, "docs", "results.md")
...
open(TARGET, "w").write(readme); print("docs/results.md section written")
